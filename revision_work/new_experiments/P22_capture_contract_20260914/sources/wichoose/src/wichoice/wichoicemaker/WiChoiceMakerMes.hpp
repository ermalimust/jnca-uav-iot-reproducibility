/**
 * Defines a concrete class to choose wifi interfaces based on measurement-based data.
 *
 * Rui Meireles (@vassar.edu) 2024
 */

#ifndef WI_CHOICE_MAKER_MES_HPP__
#define WI_CHOICE_MAKER_MES_HPP__
...
class WiChoiceMakerMes : public WiChoiceMaker {
...
public:
   ...
   */
  WiChoiceMakerMes(NperfDb& nperfDb, NperfSumStrat const& nperfSumStrat);
...
private:
  WiChoiceWriterMes wiChoiceWriterMes;
};

#endif // WI_CHOICE_MAKER_MES_HPP__
